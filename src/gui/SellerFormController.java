...
import model.exceptions.ValidationExecption;
...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		ValidationExecption exception = new ValidationExecption("Validation error");
		...
		if (dpBirthDate.getValue() == null) {
			exception.addError("birthDate", "*Campo data não pode ser vazio.");
		} else {
